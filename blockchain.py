...
class Blockchain:
    ...
    def is_chain_valid(self) -> Tuple[bool, str]:
        ...
        for i in range(1, len(self.chain)):
            ...
            # proof validity: check hash(previous.proof + current.proof)
    ...
    def valid_chain_from_nodes(self, chain_data: List[Dict]) -> Tuple[bool, List[Block]]:
        ...
        # validate candidate chain logic (similar to is_chain_valid)
    ...
    def resolve_conflicts(self) -> Tuple[bool, str]:
        ...
        for node in neighbours:
            try:
                # attempt to GET chain from node
                ...
                # jika node tidak reachable, skip
                continue
